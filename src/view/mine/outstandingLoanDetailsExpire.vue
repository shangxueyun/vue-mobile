<template>
    <div style="height: 100%;" class="outstandingLoanDetailsExpire">
...
<style>
.outstandingLoanDetailsExpire .weui-cell__ft{
    color: #000;
}
.outstandingLoanDetailsExpire .vux-label{
    color: #999;
}
</style>